...
# clone or update the `ros` package
git -C $COMPOSE_PACKAGES_DIR/ros pull origin master || git clone --depth 1 https://github.com/afdaniele/compose-pkg-ros $COMPOSE_PACKAGES_DIR/ros
